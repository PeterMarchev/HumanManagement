...
using HumanManagement.Models.ViewModels.Account;
...
namespace HumanManagement.Controllers
{
    public class AccountController : Controller
    {
        ...
        //private readonly IAdministratorService _admin;

        public AccountController(
            UserManager<WebUser> userManager,
            SignInManager<WebUser> signInManager,
            IEmailSender emailSender,
            ILogger<AccountController> logger/*, IAdministratorService admin*/)
        {
        ...
        public async Task<IActionResult> Login(LoginVM model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //var user = await _admin.GetUserByEmailAsync(model.Email);
                var result = await _signInManager.PasswordSignInAsync(model.Email, model.Password, model.RememberMe, lockoutOnFailure: false);
                if (result.Succeeded)
                {
                    _logger.LogInformation("User logged in.");

                    //var userRoles = await _admin.GetUserRolesAsync(user.Email); 
                    ...
                    //{
                    //    return RedirectToAction("DepartmentDetailsEmployee", "Department");
                    //}
